...
const Invite = () => {
    ...
    return (
        <div className="invite-container">
            ...
            <p>종민 ♡ 유라</p>
            <img src={`${process.env.NEXT_PUBLIC_ASSET_PREFIX}/images/1391260569177_20240603124445427_2197.jpg`} alt="Photo 1" />
            <img src={`${process.env.NEXT_PUBLIC_ASSET_PREFIX}/images/1393678989794_20240603124443975_1866.jpg`} alt="Photo 2" />
            <img src={`${process.env.NEXT_PUBLIC_ASSET_PREFIX}/images/person_account_60.png`} alt="Photo 3" />
